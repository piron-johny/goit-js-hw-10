...
function fetchCountries(name) {
  return fetch(`https://restcountries.com/v2/name/${name}?fields=name,capital,population,languages,flag`).then(response => response.json()).then(data => data).catch(_notiflixNotifyAio.Notify.failure('Oops, there is no country with that name'));
}
...
function onInputValue(e) {
  ...
  (0, _fetchCountries.fetchCountries)(countriesValue.trim());
}
},{"lodash":"../node_modules/lodash/lodash.js","./css/styles.css":"css/styles.css","./fetchCountries":"fetchCountries.js","lodash.debounce":"../node_modules/lodash.debounce/index.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
